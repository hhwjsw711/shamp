 ...
 * GET /api/analytics/dashboard - Get dashboard statistics/KPIs
 */
 ...
 */
export const getDashboardStatsHandler = httpAction(async (ctx, request) => {
  try {
    ...
    // Authenticate user
    const authPayload = await authenticateUser(ctx, request);
    ...
    console.error("[getDashboardStatsHandler] Error:", error);
