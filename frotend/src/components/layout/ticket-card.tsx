...
interface TicketCardProps {
  ...
  date: string
  issueType?: string
  status?: 'analyzing' | 'analyzed' | 'reviewed' | 'find_vendors' | 'requested_for_information' | 'quotes_available' | 'quote_selected' | 'fixed' | 'closed'
  onClick?: () => void
  onEdit?: () => void
  onDelete?: () => void
  className?: string
...
export function TicketCard({
  ...
  // Can edit only (no delete): find_vendors, requested_for_information, quotes_available
